...
BR_data=readtable('./../pilotdata.txt','delimiter','\t');
...
BR_data.Initial_Stim(BR_data.Quantity_Stim1>0 & BR_data.Quantity_Stim2==0)=1;
...
diff={BR_data.Stim1Fraction-BR_data.Stim2Fraction,...
    ...
    BR_data.IsStim1initialStim-0.5,...
    BR_data.Quantity_Stim1-BR_data.Quantity_Stim2};

test_diff=diff{2}; % Select the measurement you want to test: 1,2, or 3.
